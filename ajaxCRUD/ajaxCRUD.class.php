...
class ajaxCRUD{
    ...
    function insertHeader($ajax_file = "ajaxCRUD.inc.php"){
		...
		if ($this->includeJQuery){
    		...
    		echo "<script type=\"text/javascript\" src=\"http://code.jquery.com/jquery-latest.min.js\" charset=\"utf-8\"></script>\n"; 									//rel 6 - using latest version of jquery from jquery site (http://docs.jquery.com/Plugins/Validation/Validator)
    		echo "<script type=\"text/javascript\" src=\"http://ajax.aspnetcdn.com/ajax/jquery.validate/1.7/jquery.validate.min.js\" charset=\"utf-8\"></script>\n"; 		//rel 6 - added ability to validate forms fields
			echo "<script type=\"text/javascript\" src=\"http://ajaxcrud.com/code/jquery.maskedinput.js\" charset=\"utf-8\"></script>\n"; 								//rel 6 - ability to mask fields (http://digitalbush.com/projects/masked-input-plugin/)
			echo "<script src=\"" . $this->ajaxcrud_root . "validation.js\" type=\"text/javascript\" charset=\"utf-8\"></script>\n";
		}
        echo "<script src=\"" . $this->ajaxcrud_root . "javascript_functions.js\" type=\"text/javascript\" charset=\"utf-8\"></script>\n";
        ...
        if (count($this->ajaxFilter_fields) > 0){
            ...
            foreach ($this->ajaxFilter_fields as $filter_field){
				...
				if (is_array($this->allowed_values[$filter_field])){
                	...
                	$top_html .= "<input type=\"text\" size=\"$textbox_size\" name=\"$filter_field\" value=\"$filter_value\" onKeyUp=\"filterTable(this, '" . $this->db_table . "', '$filter_field', '$extra_query_params');\">";
                }
                $top_html .= "</td>";
            }
            $top_html .= "</tr></table>\n";
